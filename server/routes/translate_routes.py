...
DETECT_CHUNK = 4000
CFG_FILE_EXT = {"python": "py", "javascript": "js", "java": "java", "cpp": "cpp", "go": "go"}
...
def translate(payload: TranslateRequest) -> TranslateResponse:
    ...
    entry_name = "source.%s" % CFG_FILE_EXT.get(source_language, "txt")
    cfg_summary = build_cfg_summary([(entry_name, code)], source_language)
