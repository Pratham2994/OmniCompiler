...
def _build_prompt(source_language: str, target_language: str, source_code: str,
                  options: Dict[str, bool], cfg_summary: Optional[Dict[str, Any]] = None) -> str:
...
def translate_with_gemini(
    ...
    for lang in target_languages:
        ...
        prompt = _build_prompt(resolved_source, norm, source_code, opts, cfg_summary=cfg_summary)
