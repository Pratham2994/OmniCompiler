      ...
      <header className="h-14 border-b border-neutral-200/60 dark:border-white/10 flex items-center justify-between px-3 gap-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <nav className="flex items-center gap-2" aria-label="Primary">
            <Link
              to="/run"
              className="px-3 py-1.5 text-sm rounded border border-neutral-200/60 dark:border-white/10 bg-[var(--oc-primary-600)] text-white"
            >
              Run
            </Link>
            <Link
              to="/debug"
              className="px-3 py-1.5 text-sm rounded border border-neutral-200/60 dark:border-white/10 bg-[var(--oc-surface-2)]"
